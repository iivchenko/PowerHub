...
Set-Variable -Name paas   -Value "$bets\Payment - PAAS\paas"Set-Variable -Name psp    -Value "$bets\Payment - PSP\psp"Set-Variable -Name ppv    -Value "$bets\Payment - Payment Pages\ppv"
...
function go()
{
    ...
    (
        ...
        [ValidateSet("paas", "psp", "bets","kyc","ppv")]
        [string]$name
    )
